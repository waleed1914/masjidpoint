...
{const style=document.createElement('link');style.rel='stylesheet';style.href='password-controls.css?v=2';document.head.appendChild(style);const script=document.createElement('script');script.src='password-controls.js?v=2';document.body.appendChild(script)}
