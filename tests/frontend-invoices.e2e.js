...
const {spawn}=require('child_process'),path=require('path'),edge='C:\\Program Files (x86)\\Microsoft\\Edge\\Application\\msedge.exe',port=9933,base=process.env.MASJIDPOINT_URL||'http://127.0.0.1:4174';
