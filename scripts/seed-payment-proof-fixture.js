...
async function main(){
 ...
 const response=await fetch(`${base}/api/collection/masjidPointJobs`,{method:'PUT',headers:{'Content-Type':'application/json','X-Admin-Name':'Automated test fixture'},body:JSON.stringify(jobs)});
